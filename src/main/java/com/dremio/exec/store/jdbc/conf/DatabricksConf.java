...
@SourceType(value = "DatabricksARP", label = "Databricks",uiConfig = "databricks-layout.json")
public class DatabricksConf extends AbstractArpConf<DatabricksConf> {
  private static final String ARP_FILENAME = "arp/implementation/databricks-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.databricks.DatabricksDriver";
